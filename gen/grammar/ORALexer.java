...
public class ORALexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "T__22", "EQ", "NEQ", "LT", 
			"GT", "LE", "GE", "AND", "OR", "NOT", "ID", "STRING", "INT", "FLOAT", 
			"WS"
		};
	}
	...
	public ORALexer(CharStream input) {
		super(input);
